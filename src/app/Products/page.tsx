  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        <hr className="my-8 w-32 h-[4px] bg-[#EEB960] border-0" />
        <div className="grid items-center">
          <p className={`text-4xl text-[#46362B]`}>Arranjos de Flores</p>
          <p className={`text-4xl text-[#46362B]`}>Elegância Natural</p>
        </div>
        <hr className="my-8 w-32 h-[4px] bg-[#EEB960] border-0" />
      </div>
      <p className="text-2xl w-2/3 font-semibold py-7">
